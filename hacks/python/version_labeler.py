...
parser.add_argument('-v', '--version', help='version to use in annotation')
...
CONST_VERSION_LABEL = "kubeaddons.mesosphere.io/kubeaddons-configs-version"
...
for file in addonFiles:
    ...
    if args.remove:
        try:
            ...
            print("Key 'catalog.kubeaddons.mesosphere.io/repository-version' not found")
    else:
        addonyaml[CONST_METADATA_KEY][CONST_LABEL_KEY][CONST_VERSION_LABEL] = args.version
        addon.seek(0)
        addon.write("---\n")
